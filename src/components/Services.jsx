    ...
    return (
        <div className="flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services">
            ...
            <div className="flex-1 flex flex-col justify-start items-center">
                ...
                <ServiceCard color="bg-[#8945F8]" title="Best exchange rates" icons={<BiSearchAlt fontSize={21} className="text-white" />} subtitle="Security is guaranted. We always maintain privacy and maintain the quality of our products." />        
                <ServiceCard color="bg-[#f84550]" title="Fastest transactions" icons={<RiHeart2Fill fontSize={21} className="text-white"/>} subtitle="Security is guaranted. We always maintain privacy and maintain the quality of our products." />        
            </div>
        </div>
    )
}
